...
WITH last_updated_data as
    ...
    initial_s3_data as 
    (SELECT *, CASE WHEN utm_campaign ~* 'ds01-demandgen-video' THEN 'GOOGLE' ELSE channel END as channel,
        {{ get_date_parts('activation_date') }} FROM last_updated_data WHERE utm_campaign IS NOT NULL),
