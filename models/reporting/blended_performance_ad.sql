    ...
    FROM
        (SELECT 'Google Ads' as channel, yt.date, yt.date_granularity, country as market, product, campaign_name::varchar as google_campaign, utm_campaign::varchar, 
            ...
            CASE 
                ...
                WHEN ad_name ~* 'DD_SEE20_YTRecuts_T2CListicle_De-bloatFast_C2_9x16_16x9' THEN 'DD_SEE20-YTRecuts_T2CListicle_De_bloatFast_C2_16x9'
                WHEN ad_name ~* 'DD_SEE20-YTRecuts_T2CListicle_De-bloatFast_C2_9x16_16x9' THEN 'DD_SEE20-YTRecuts_T2CListicle_De_bloatFast_C2_16x9'
