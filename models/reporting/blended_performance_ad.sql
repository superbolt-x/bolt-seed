    ...
    ({%- for date_granularity in date_granularity_list %}    
        SELECT '{{date_granularity}}' as date_granularity, {{date_granularity}} as date,
            ...
            CASE 
                ...
                WHEN utm_term ~* 'DD_SEE20_YTRecuts_T2CListicle_De-bloatFast_C2_9x16_16x9' THEN 'DD_SEE20_YTRecuts_T2CListicle_De-bloatFast_C2_9x16_16x9'
                WHEN utm_term ~* 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_4x5-Video' THEN 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_4x5-Video'
                WHEN utm_term ~* 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_9x16_4x5' THEN 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_9x16_4x5'
                WHEN utm_term ~* 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_9x16_4x5-Video' THEN 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_9x16_4x5-Video'
                WHEN utm_term ~* 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_9x16-Video' THEN 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_9x16-Video'
                ...
                WHEN utm_term ~* 'DS-01_DemandGenAsset_V1_PoopingEveryDay_20250113' THEN 'DS-01_DemandGenAsset_V1_PoopingEveryDay_20250113'
                WHEN utm_term ~* 'DS-01_DemandGenAsset_V2_20250113_1200x628' THEN 'DS-01_DemandGenAsset_V2_20250113_1200x628'
                WHEN utm_term ~* 'DS-01_DemandGenAsset_V3_PoopingEveryDay' THEN 'DS-01_DemandGenAsset_V3_PoopingEveryDay'
                WHEN utm_term ~* 'DS-01_DemandGenAsset_V3_PoopingEveryDay_20250113_1200x628' THEN 'DS-01_DemandGenAsset_V3_PoopingEveryDay_20250113_1200x628'
                WHEN utm_term ~* 'DS-01_FastSustainedReliefMessagingYoutube_V1-Video' THEN 'DS-01_FastSustainedReliefMessagingYoutube_V1-Video'
                WHEN utm_term ~* 'DS-01_FastSustainedReliefMessagingYoutube_V2-Video' THEN 'DS-01_FastSustainedReliefMessagingYoutube_V2-Video'
                WHEN utm_term ~* 'DS-01_GraphicPromoExp_Static2a_NOW25-Video' THEN 'DS-01_GraphicPromoExp_Static2a_NOW25-Video'
                WHEN utm_term ~* 'DS-01_Member_Stat_Hook_V1_1x1-Video' THEN 'DS-01_Member_Stat_Hook_V1_1x1-Video'
                WHEN utm_term ~* 'DS-01_Member_Stat_Hook_V1_20240716_1080x1080' THEN 'DS-01_Member_Stat_Hook_V1_20240716_1080x1080'
                WHEN utm_term ~* 'DS-01_Member_Stat_Hook_V1_9x16_1x1-Video' THEN 'DS-01_Member_Stat_Hook_V1_9x16_1x1-Video'
                WHEN utm_term ~* 'DS-01_Member_Stat_Hook_V1_9x16-Video' THEN 'DS-01_Member_Stat_Hook_V1_9x16-Video'
                WHEN utm_term ~* 'DS-01_NewPoopingEverydayTemplateTesting_Static_V3-Video' THEN 'DS-01_NewPoopingEverydayTemplateTesting_Static_V3-Video'
                WHEN utm_term ~* 'DS-01_NewPoopingEverydayTemplateTesting_Static_V4' THEN 'DS-01_NewPoopingEverydayTemplateTesting_Static_V4'
                WHEN utm_term ~* 'DS-01_NewPoopingEverydayTemplateTesting_Static_V4-Video' THEN 'DS-01_NewPoopingEverydayTemplateTesting_Static_V4-Video'
                WHEN utm_term ~* 'DS-01_Q524TopPerformerRefreshes_V2_Capsule_NOW25-Video' THEN 'DS-01_Q524TopPerformerRefreshes_V2_Capsule_NOW25-Video'
                WHEN utm_term ~* 'DS-01_Q524TopPerformerRefreshes_V3_Capsule_Opt2_NOW25-Video' THEN 'DS-01_Q524TopPerformerRefreshes_V3_Capsule_Opt2_NOW25-Video'
                WHEN utm_term ~* 'DS-01_QualityOfLifeExploration_Static_V1_20240719_1080x1080-Video' THEN 'DS-01_QualityOfLifeExploration_Static_V1_20240719_1080x1080-Video'
                WHEN utm_term ~* 'DS-01_QualityOfLifeExploration_Static_V2_20240719_1080x1080-Video' THEN 'DS-01_QualityOfLifeExploration_Static_V2_20240719_1080x1080-Video'
                WHEN utm_term ~* 'DS-01_SurvivabilityItr_op1_20240327_1x1' THEN 'DS-01_SurvivabilityItr_op1_20240327_1x1'
                WHEN utm_term ~* 'DS-01_Top_Quote_Light_Motion_V1_20240625_1080x1920' THEN 'DS-01_Top_Quote_Light_Motion_V1_20240625_1080x1920'
                ...
                WHEN utm_term ~* 'DD-SEE20-YTRecuts-T2CListicle-De-bloatFast-C2-16x9' THEN 'DD-SEE20-YTRecuts-T2CListicle-De-bloatFast-C2-16x9'
                ...
                WHEN utm_term ~* 'DD_SEE02_T2CListicle_PoopEveryday_V4_9x16' THEN 'DD_SEE02_T2CListicle_PoopEveryday_V4_9x16'
                WHEN utm_term ~* 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_DS-01_4x5_V1' THEN 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_4x5-Video'
                WHEN utm_term ~* 'DH_2in1_Lifestyle_Video_HQ_42s_9x16' THEN 'DH_2in1_Lifestyle_Video_HQ_42s_9x16'
                ...
                WHEN utm_term ~* 'DS-01-DemandGenAsset-V1-PoopingEveryDay_20250113' THEN 'DS-01_DemandGenAsset_V1_PoopingEveryDay_20250113'
    ...
    FROM
        (SELECT 'Google Ads' as channel, yt.date, yt.date_granularity, country as market, product, campaign_name::varchar as google_campaign, utm_campaign::varchar, 
            ...
            CASE 
                ...
                WHEN ad_name ~* 'DD_SEE20_YTRecuts_T2CListicle_De-bloatFast_C2_9x16_16x9' THEN 'DD-SEE20-YTRecuts-T2CListicle-De-bloatFast-C2-16x9'
                WHEN ad_name ~* 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_4x5-Video' THEN 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_4x5-Video'
                WHEN ad_name ~* 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_9x16_4x5' THEN 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_9x16_4x5'
                WHEN ad_name ~* 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_9x16_4x5-Video' THEN 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_9x16_4x5-Video'
                WHEN ad_name ~* 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_9x16-Video' THEN 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_9x16-Video'
                ...
                WHEN ad_name ~* 'DS-01_DemandGenAsset_V1_PoopingEveryDay_20250113' THEN 'DS-01_DemandGenAsset_V1_PoopingEveryDay_20250113'
                WHEN ad_name ~* 'DS-01_DemandGenAsset_V2_20250113_1200x628' THEN 'DS-01_DemandGenAsset_V2_20250113_1200x628'
                WHEN ad_name ~* 'DS-01_DemandGenAsset_V3_PoopingEveryDay' THEN 'DS-01_DemandGenAsset_V3_PoopingEveryDay'
                WHEN ad_name ~* 'DS-01_DemandGenAsset_V3_PoopingEveryDay_20250113_1200x628' THEN 'DS-01_DemandGenAsset_V3_PoopingEveryDay_20250113_1200x628'
                WHEN ad_name ~* 'DS-01_FastSustainedReliefMessagingYoutube_V1-Video' THEN 'DS-01_FastSustainedReliefMessagingYoutube_V1-Video'
                WHEN ad_name ~* 'DS-01_FastSustainedReliefMessagingYoutube_V2-Video' THEN 'DS-01_FastSustainedReliefMessagingYoutube_V2-Video'
                WHEN ad_name ~* 'DS-01_GraphicPromoExp_Static2a_NOW25-Video' THEN 'DS-01_GraphicPromoExp_Static2a_NOW25-Video'
                WHEN ad_name ~* 'DS-01_Member_Stat_Hook_V1_1x1-Video' THEN 'DS-01_Member_Stat_Hook_V1_1x1-Video'
                WHEN ad_name ~* 'DS-01_Member_Stat_Hook_V1_20240716_1080x1080' THEN 'DS-01_Member_Stat_Hook_V1_20240716_1080x1080'
                WHEN ad_name ~* 'DS-01_Member_Stat_Hook_V1_9x16_1x1-Video' THEN 'DS-01_Member_Stat_Hook_V1_9x16_1x1-Video'
                WHEN ad_name ~* 'DS-01_Member_Stat_Hook_V1_9x16-Video' THEN 'DS-01_Member_Stat_Hook_V1_9x16-Video'
                WHEN ad_name ~* 'DS-01_NewPoopingEverydayTemplateTesting_Static_V3-Video' THEN 'DS-01_NewPoopingEverydayTemplateTesting_Static_V3-Video'
                WHEN ad_name ~* 'DS-01_NewPoopingEverydayTemplateTesting_Static_V4' THEN 'DS-01_NewPoopingEverydayTemplateTesting_Static_V4'
                WHEN ad_name ~* 'DS-01_NewPoopingEverydayTemplateTesting_Static_V4-Video' THEN 'DS-01_NewPoopingEverydayTemplateTesting_Static_V4-Video'
                WHEN ad_name ~* 'DS-01_Q524TopPerformerRefreshes_V2_Capsule_NOW25-Video' THEN 'DS-01_Q524TopPerformerRefreshes_V2_Capsule_NOW25-Video'
                WHEN ad_name ~* 'DS-01_Q524TopPerformerRefreshes_V3_Capsule_Opt2_NOW25-Video' THEN 'DS-01_Q524TopPerformerRefreshes_V3_Capsule_Opt2_NOW25-Video'
                WHEN ad_name ~* 'DS-01_QualityOfLifeExploration_Static_V1_20240719_1080x1080-Video' THEN 'DS-01_QualityOfLifeExploration_Static_V1_20240719_1080x1080-Video'
                WHEN ad_name ~* 'DS-01_QualityOfLifeExploration_Static_V2_20240719_1080x1080-Video' THEN 'DS-01_QualityOfLifeExploration_Static_V2_20240719_1080x1080-Video'
                WHEN ad_name ~* 'DS-01_SurvivabilityItr_op1_20240327_1x1' THEN 'DS-01_SurvivabilityItr_op1_20240327_1x1'
                WHEN ad_name ~* 'DS-01_Top_Quote_Light_Motion_V1_20240625_1080x1920' THEN 'DS-01_Top_Quote_Light_Motion_V1_20240625_1080x1920'
                ...
                WHEN ad_name ~* 'DD_SEE02_T2CListicle_PoopEveryday_V4_9x16' THEN 'DD_SEE02_T2CListicle_PoopEveryday_V4_9x16'
                WHEN ad_name ~* 'DH_2in1_Lifestyle_Video_HQ_42s_9x16' THEN 'DH_2in1_Lifestyle_Video_HQ_42s_9x16'
