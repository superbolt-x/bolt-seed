    ...
    ({%- for date_granularity in date_granularity_list %}    
        SELECT '{{date_granularity}}' as date_granularity, {{date_granularity}} as date,
            ...
            CASE 
                ...
                WHEN utm_term ~* 'DD-SEE20-YTRecuts-T2CListicle-De-bloatFast-C2-16x9' THEN 'DD_SEE20-YTRecuts-T2CListicle-De-bloatFast-C2-16x9'
                WHEN utm_term ~* 'DD_SEE20-YTRecuts-T2CListicle-De-bloatFast-C2-16x9' THEN 'DD_SEE20-YTRecuts-T2CListicle-De-bloatFast-C2-16x9'
    ...
    FROM
        (SELECT 'Google Ads' as channel, yt.date, yt.date_granularity, country as market, product, campaign_name::varchar as google_campaign, utm_campaign::varchar, 
            ...
            CASE 
                ...
                WHEN ad_name ~* 'DD_SEE20_YTRecuts_T2CListicle_De-bloatFast_C2_9x16_16x9' THEN 'DD_SEE20-YTRecuts-T2CListicle-De-bloatFast-C2-16x9'
