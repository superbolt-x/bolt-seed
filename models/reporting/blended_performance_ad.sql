...
WITH initial_s3_data as 
    ...
    ({%- for date_granularity in date_granularity_list %}    
        SELECT '{{date_granularity}}' as date_granularity, {{date_granularity}} as date,
            ...
            CASE
                WHEN utm_term = 'Bloating_30_FINECUT_A_Broadcast-Video' THEN 'Bloating_30_FINECUT_A_Broadcast'
                ...
                WHEN utm_term = 'DD_SEE02_T2CListicle_PoopEveryday_4x5_V4-Video' THEN 'DD_SEE02_T2CListicle_PoopEveryday_V4_4x5-Video_In-Stream'
                WHEN utm_term = 'DD_SEE02_T2CListicle_PoopEveryday_4x5_V4-Video Image' THEN 'DD_SEE02_T2CListicle_PoopEveryday_V4_4x5-Video_In-Stream'
                WHEN utm_term = 'DD_SEE02_T2CListicle_PoopEveryday_4x5_V4-Video_In-Stream' THEN 'DD_SEE02_T2CListicle_PoopEveryday_V4_4x5-Video_In-Stream'
                WHEN utm_term = 'DD_SEE02_T2CListicle_PoopEveryday_4x5_V4-Video_Shorts' THEN 'DD_SEE02_T2CListicle_PoopEveryday_V4_4x5-Video_In-Stream'
                WHEN utm_term = 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_DS-01_4x5_V1-Video' THEN 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_4x5-Video_In-Stream'
                WHEN utm_term = 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_DS-01_4x5_V1-Video_In-Stream' THEN 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_4x5-Video_In-Stream'
                WHEN utm_term = 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_DS-01_4x5_V1-Video_Shorts' THEN 'DD_SEE24_WhiteboardExplainer_C4I_Explainer_Hook1-Survive_SmileyFace_V1_4x5-Video_In-Stream'
                WHEN utm_term = 'DD-SEE20-YTRecuts-T2CListicle-De-bloatFast-C2-16x9-Video' THEN 'DD_SEE20_YTRecuts_T2CListicle_De-bloatFast_C2_9x16_16x9'
                WHEN utm_term = 'DD-SEE20-YTRecuts-T2CListicle-De-bloatFast-C2-16x9-Video Image' THEN 'DD_SEE20_YTRecuts_T2CListicle_De-bloatFast_C2_9x16_16x9'
                WHEN utm_term = 'DH_Const_UGC_Stomach_Kaleina_Video_39s_DD-Video' THEN 'DH_Const_UGC_Stomach_Kaleina_Video_39s_DD'
                WHEN utm_term = 'DH_Const_UGC_Stomach_Kaleina_Video_39s_DD-Video_In-Feed' THEN 'DH_Const_UGC_Stomach_Kaleina_Video_39s_DD'
                ...
                WHEN utm_term = 'DH_Const_UGC_Stomach_Kaleina_Video_39s_DD-Video_shorts' THEN 'DH_Const_UGC_Stomach_Kaleina_Video_39s_DD'
                WHEN utm_term = 'DH_PB_Value_WK_Static_HQ_V1-Video Image' THEN 'DH_PB_Value_WK_Static_HQ_V1'
                ...
                WHEN utm_term = 'DH_Poop_UGC_WK_Video_17s_DD_V2_NOW25-Video_Shorts' THEN 'DH_Poop_UGC_WK_Video_17s_DD_V2_NOW25_4x5_9x16-Video_Shorts'
                ...
                WHEN utm_term = 'DS-01_Member_Stat_Hook_V1_20240716_1080x1080-Video' THEN 'DS-01_Member_Stat_Hook_V1_9x16-Video'
                WHEN utm_term = 'DS-01_Member_Stat_Hook_V1_20240716_1080x1080-Video_In-Feed' THEN 'DS-01_Member_Stat_Hook_V1_1x1-Video_In-Feed'
                WHEN utm_term = 'DS-01_Member_Stat_Hook_V1_20240716_1080x1080-Video_In-Stream' THEN 'DS-01_Member_Stat_Hook_V1_1x1-Video_In-Stream'
                WHEN utm_term = 'DS-01_Member_Stat_Hook_V1_20240716_1080x1080-Video_shorts' THEN 'DS-01_Member_Stat_Hook_V1_9x16-Video_shorts'
                ...
                WHEN utm_term = 'DS-01_Q524TopPerformerRefreshes_V3_Capsule_Opt2_NOW25-Video Image' THEN 'DS-01_Q524TopPerformerRefreshes_V3_Capsule_Opt2_NOW25-Video+Image'
                ...
                WHEN utm_term = 'DS-01-DemandGenAsset-V1-PoopingEveryDay_20250113-Video Image' THEN 'DS-01_DemandGenAsset_V1_PoopingEveryDay_20250113'
                WHEN utm_term = 'DS01_KOLYouTubeTesting_V1_1080x1080-Video_In-Stream' THEN 'DS01_KOLYouTubeTesting_V1_1x1_16x9-Video_In-Stream'
                WHEN utm_term = 'DS01_KOLYouTubeTesting_V1_1080x1080-Video_Shorts' THEN 'DS01_KOLYouTubeTesting_V1_9x16-Video_Shorts'
                ...
                WHEN utm_term = 'DS01_KOLYouTubeTesting_V3_1080x1080-Video' THEN 'DS01_KOLYouTubeTesting_V3_1080x1080-Video_In-Feed'
    ...
    FROM
        ...
        FULL OUTER JOIN (SELECT utm_campaign::varchar, google_campaign, COUNT(*) FROM s3_data GROUP BY 1,2) utm ON yt.campaign_name = utm.google_campaign 
